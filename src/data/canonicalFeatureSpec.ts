  ...
  canonical_feature_spec: {
      ...
      },
      {
        ...
        features: [
          ...
          },
          {
            ...
            unique_to_carlos: true,
            competitive_notes: "Unique to CARLOS — tracks test credit consumption which is core to SGS's business model."
          },
          {
            name: "Custom Reports",
    ...
    administration: {
      ...
      configuration: {
        ...
        branding_customization: "no (SGS branding hardcoded)"
      },
    ...
    cross_cutting_capabilities: {
      ...
      theming: {
        ...
        custom_themes: "no",
        sgs_branding: "SGS-inspired deep blue primary (221 83% 53%). Logo in sidebar. Inter font family. Enterprise-grade command center aesthetic."
      }
    },
    ...
    comparison_positioning: {
      vs_inspectorio: {
        carlos_strengths: [
          ...
          "Test balance/credit tracking — aligned with SGS's business model",
      ...
      vs_sgs_smart: {
        ...
        smart_migration_relevance: "CARLOS demonstrates the next-generation capabilities that go beyond SMART's current scope. If SMART migration proceeds, CARLOS's architecture could serve as the frontend layer for SGS's customer-facing compliance portal, complementing SMART's backend operational capabilities."
      }
    },
